...
public class Cookie implements Runnable{
	...
	//constructor
	public Cookie(
			FishBowlFrame frame, JPanel bowlPanel, JLabel cLabel
			, int xPos, int yPos, ArrayList<Cookie> cookies, ArrayList<JLabel> cList)
	{
		this.frame = frame;
